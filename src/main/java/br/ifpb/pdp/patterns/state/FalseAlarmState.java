...
public class FalseAlarmState implements IncidentState {
    public FalseAlarmState(IncidentContext context) {
    ...
    @Override public String getStatusName() { return "Alarme Falso"; }
}
